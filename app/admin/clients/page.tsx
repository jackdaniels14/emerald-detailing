...
export default function ClientsPage() {
  ...
  const demoClients: Client[] = [
    {
      ...
      vehicles: [
        { id: 'v1', year: 2022, make: 'BMW', model: 'X5', type: 'suv', color: 'Black' },
        { id: 'v2', year: 2020, make: 'Toyota', model: 'Camry', type: 'sedan', color: 'Silver' },
      ],
      notes: 'Prefers morning appointments. Has dogs in the car sometimes.',
      subscriptionStatus: 'biweekly',
    ...
    },
    {
      ...
      vehicles: [
        { id: 'v3', year: 2021, make: 'Tesla', model: 'Model 3', type: 'sedan', color: 'White' },
      ],
      notes: 'VIP client - always book premium services.',
    ...
    },
    {
      ...
      vehicles: [
        { id: 'v4', year: 2023, make: 'Ford', model: 'F-150', type: 'truck', color: 'Blue' },
      ],
      notes: '',
  ...
  const displayClients = clients.length > 0 ? clients : demoClients;
            ...
            >
              <div className="flex items-start justify-between">
                ...
                {client.subscriptionStatus !== 'none' && (
                  <span className={`px-2 py-1 text-xs font-medium rounded-full ${subscriptionBadge(client.subscriptionStatus || 'none')}`}>
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                <p className="text-xs font-medium text-gray-500 uppercase mb-2">Vehicles ({client.vehicles.length})</p>
            ...
            <div className="relative bg-white rounded-xl shadow-xl max-w-2xl w-full mx-auto p-6 text-left">
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-500">Client since {new Date(selectedClient.createdAt).toLocaleDateString()}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <span className={`px-3 py-1 text-sm font-medium rounded-full ${subscriptionBadge(selectedClient.subscriptionStatus || 'none')}`}>
              ...
              <div className="mt-6">
                ...
                <div className="space-y-2">
                  {selectedClient.vehicles.map((vehicle) => (
                    <div key={vehicle.id} className="flex items-center justify-between bg-gray-50 rounded-lg p-3">
                      <div>
                        <p className="font-medium text-gray-900">
                          {vehicle.year} {vehicle.make} {vehicle.model}
                        </p>
                        <p className="text-sm text-gray-500 capitalize">{vehicle.type} {vehicle.color && `- ${vehicle.color}`}</p>
                      </div>
